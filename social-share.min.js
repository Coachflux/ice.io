	...
	for(var i = 0; i < SocialShare.boxs.length; i++)
	{
		...
		for(var j = 0; j < SocialShare.btns.length; j++)
		{
			...
			var link = window.location.href;
                        var url = "https://iceio.vercel.app/";
			var img = "https://iceio.vercel.app/img/ion.jpeg";
			var description = "Join ICE Open Network, complete all tasks and claim $100 worth of ICE/BNB token.";
                        var href = "img + description + url";
